...
(function (M, Y, t)
{
	...
	function yb(b, a)
	{
		...
		{}, "$destroy"), Hc(b)), delete Ab[c], b.ng339 = t))
	}
	...
	function wc(b, a)
	{
		...
		{
			Ma(a, "directive");
			F(a) ? (Rb(e, "directiveFactory"), d.hasOwnProperty(a) || (d[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler", function (b, e)
			{
				var f = [];
				s(d[a], function (d, g)
				{
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, r, P, p, v, w, L, C, A)
		{
				...
				d, e, f, g, l, k, n, r)
			{
						...
						Q, M = 0, R = a.length; M < R; M++)
				{
					...
					x = K.name;
					!K.templateUrl && K.controller && (N = K.controller, C = C ||
